#ifndef CC_COMMON_MYSQL_H__
#define CC_COMMON_MYSQL_H__
...
* @return  0:成功,其他值创建失败
 */
int cc_mysql_exec(const char *sql, size_t len, void **result);
/**
...
int cc_mysql_parse_conf_ex(mysql_connection_t *tokengen_uri);
#ifdef __cplusplus
}
#endif
